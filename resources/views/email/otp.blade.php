    ...
    <div class="wrap_body" style="background: #efefef;    display: inline-block;width: 100%;padding: 60px 0px;">
      <div class="wrap_container" style="background: #fff; margin: 0 auto; width: 80%;display: block;box-shadow: 1px 1px 15px -3px;">
        ...
        <div class="image-container">
          <img src="{{ asset('images/mail/accepted.jpg') }}" alt="Banner">
        </div>
        <div class="content-section" style="padding:45px 45px 10px 45px">
          ...
          <p style="line-height: 26px;text-align: justify;">Thanks for registering with us.</p>
          <p style="line-height: 26px;text-align: justify;">Welcome to Weafricans Marketplace. A distinctive mobile app built to connect African businesses, services & events in a single platform, no matter your location.</p>
           <p style="line-height: 26px;text-align: justify;"> Your one time password is : {{ $user->otp }}  </p>
           <p style="line-height: 26px;text-align: justify;">We look forward to welcoming you aboard.<p>
