    ...
    <div class="wrap_body" style="background: #efefef;    display: inline-block;width: 100%;padding: 60px 0px;">
      <div class="wrap_container" style="background: #fff; margin: 0 auto; width: 80%;display: block;box-shadow: 1px 1px 15px -3px;">
        ...
        <div class="image-container">
          <img src="{{ asset('images/mail/accepted.jpg') }}">
        </div>
        <div class="content-section" style="padding:45px 45px 10px 45px">
          <h3><strong>Subject : </strong>Welcome aboard! Let's get to business </h3>
          <h4 style="color: #33c0c9;font-weight: bold;font-size: 22px;margin-bottom: 5px;">Hello {{ $user->first_name.' '.$user->last_name }},</h4>
          <p style="line-height: 26px;text-align: justify;">Welcome to Weafricans! Find African businesses, connect with skill professionals.Reach out to entertainment professionals in our Media &amp; Entertainment category,Check out for African events around you and book tickets. </p>
          <p style="line-height: 26px;text-align: justify;">As business user, list your business and services and expand your chances of getting reached. Explore most features of weafricans and engage your customers with them free of charge, use our promotion packages to promote your business to any country,
          state or city of your choice.</p>
          <p style="line-height: 26px;text-align: justify;">Create free &amp; paid events, sell tickets and receive payment the next day in your bank account. Use our check in app to check in your attendees.</p>
          <p style="line-height: 26px;text-align: justify;">Weafricans is simply connecting, relax with us & connect, you’re in good company.</p>
          <p>One Continent In One App <br>As an African, if there is one app you need to download in your life time, download weafricans.</p>
