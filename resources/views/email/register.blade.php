    ...
    <div class="wrap_body" style="background: #efefef;    display: inline-block;width: 100%;padding: 60px 0px;">
      <div class="wrap_container" style="background: #fff; margin: 0 auto; width: 80%;display: block;box-shadow: 1px 1px 15px -3px;">
        <div class="header_container">
          <img src="{{ asset('images/mail/logo.png') }}" alt="Logo">
        </div>
        <div class="image-container">
          <img src="{{ asset('images/mail/registration-banner.jpg') }}">
        </div>
        <div class="content-section" style="padding:45px 45px 10px 45px">
          <h3><strong>Subject : </strong> Welcome to our Business world</h3>
          <h4 style="color: #33c0c9;font-weight: bold;font-size: 22px;margin-bottom: 5px;">Hello {{ $user->first_name.' '.$user->last_name }},</h4>
          <p style="line-height: 26px;text-align: justify;">Weafricans simply connects, businesses registered on weafricans would never be the same after couple of months. </p>
          <p style="line-height: 26px;text-align: justify;">We promote business window and everything in it and guess what, no just that, we provide you access to communicate and engage with your audience without losing a single inquiry from your sudience.</p>
          <p style="line-height: 26px;text-align: justify;">If you are a premium member, our in app mass message features will enable you to constantly engage all your followers with promotional messages free of charge and unlimited number of times on unlimited number of followers.</p>
          <p style="line-height: 26px;text-align: justify;">You can have access to your followers leads to enable you market from any medium at any time.</p>
          <p style="line-height: 26px;text-align: justify;">You can use our ads packages to promote your businesses across country, states and city. It’s is simply the best.</p>
          <p style="line-height: 26px;text-align: justify;">Our events section will enable you to create multiple events,track the number of people that declare interest to attend to your events, sell tickets and check in your attendees.We have live desk help chat 24/7 in the app and on our website.
          We are ready to assist you to set you up at any time.</p>
          <p style="line-height: 26px;text-align: justify;">Delve into the app now and experience the beauty of African business connectivity.</p>
