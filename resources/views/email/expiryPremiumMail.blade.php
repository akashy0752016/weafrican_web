    ...
    <div class="wrap_body" style="background: #efefef;    display: inline-block;width: 100%;padding: 60px 0px;">
      <div class="wrap_container" style="background: #fff; margin: 0 auto; width: 80%;display: block;box-shadow: 1px 1px 15px -3px;">
        ...
        <div class="content-section" style="padding:45px 45px 10px 45px">
          <h4 style="color: #33c0c9;font-weight: bold;font-size: 22px;margin-bottom: 5px;">Hello {{ $userSubscriptionPlan->user->first_name }},</h4>
          <p style="padding-top: 10px;margin-bottom: 0px;"> Premium Plan Expiry Mail </p>
          <p style="line-height: 26px;text-align: justify;">Your premium subscription plan has expired. Kindly,autorenew your subscription plan to continue your business promotion. </p>
