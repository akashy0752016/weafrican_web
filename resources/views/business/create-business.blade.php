                ...
                <form id="register-form" class="form-horizontal" role="form" method="POST" action="{{ url('/register-business') }}" enctype='multipart/form-data'>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3 no_padd form-group">
                            <input required type="text" class="form-control" name="first_name" value="{{ Auth::user()->first_name }}" maxlength="15" pattern="^[a-zA-Z\s]+$" autofocus placeholder="First Name">
                        ...
                        <div class="col-md-3 form-group">
                            <input required type="text" class="form-control" name="last_name" value="{{Auth::user()->last_name }}" maxlength="15" pattern="^[a-zA-Z\s]+$" autofocus placeholder="Last Name">
...
SUN  :   Closed
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 form-group">
                            <input required type="email" placeholder="Email" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,4}$" class="form-control" name="email" value="{{ Auth::user()->email }}" disabled>
                            @if ($errors->has('email'))
                                <span class="help-block">
            ...
            fields: {
                    ...
                    pin_code: {
                        validators: {
                            ...
                            numeric: {
                                message: 'The pin code can consist only numbers.'
                            },
                            notEmpty: {
